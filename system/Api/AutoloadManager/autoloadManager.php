<?php
     ...
     */
    class autoloadManager implements autoloadManager_interface{
        /**
         ...
         * @internal param string $folder Folder to process
         * @return void
         */
        private function saveToFile(array $classes){
            ...
            $content .= ' * ' . PHP_EOL;
            $content .= ' * @authors      LTD Shalvasoft' . PHP_EOL;
            $content .= ' * @authors      Shalva Kvaratskhelia' . PHP_EOL;
            $content .= ' * ' . PHP_EOL;
